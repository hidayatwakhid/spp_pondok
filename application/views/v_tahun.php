                ...
                foreach ($tahun as $thn) : ?>
                    <tr class="text-center">
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('c_tahun/delete/' . $thn->id_thn) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
...
<?php foreach ($tahun as $thn) { ?>
    <div class="modal fade" id="edit<?= $thn->id_thn ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('c_tahun/edit/' . $thn->id_thn) ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nominal_tagihan" id="" class="form-control" value="<?= $thn->nominal_tagihan ?>">
