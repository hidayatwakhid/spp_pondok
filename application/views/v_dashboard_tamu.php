...
<body class="layout-top-nav" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-green">
            <div class="container">
                <a href="<?= base_url('c_login_tamu') ?>" class="navbar-brand">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-info card-outline">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Ini adalah halaman dimana para orang tua dapat melihat riwayat pembayaran syahriah
                                    putra-putrinya.
                                </p>
                            </div>
                        </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-sm btn-info" title=""
                                            href="<?= base_url('c_login_tamu/lihat/') ?><?= $san->id ?>">Lihat</a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
